...
AUDHD_DAY_PLANS = {
    "Hétfő": {
        ...
        "description": "2 órás mélyfókusz: 10-30 oldalas könyvvázlat, Gemini képgenerálás, Drive szinkron és nyomdakész KDP belső PDF.",
        "target_minutes": 120,
        "tasks": [
            "🎯 1. Téma, célközönség (Gyerek/Felnőtt) és KDP könyvcím meghatározása (15 perc)",
            "✨ 2. Könyvvázlat, KJV igék, színpaletta és Gemini promptok generálása az appban (25 perc)",
            "🤖 3. Gemini Gem Mester Utasítás beállítása és képek legenerálása a Gemini Web felületén (40 perc)",
            "📁 4. Képek mentése a Google Drive projektmappába és begyűjtés ellenőrzése az appban (20 perc)",
            "🚀 5. Nyomdakész 8.5×11\" KDP belső PDF összeállítása ReportLab-bal és ellenőrzése (20 perc)"
        ]
    },
    "Kedd": {
        ...
        "target_minutes": 120,
        "tasks": [
            "🖼️ 1. 5 db 4:5 arányú művészi Skandináv falikép prompt megtervezése az appban (20 perc)",
            "✂️ 2. Chibi / Akvarell clipart illusztrációk legenerálása a Gemini felületén (35 perc)",
            "✨ 3. Háttérmentesítés és képek mentése a Drive 04_🖼️_ETSY_DIGITAL mappába (25 perc)",
            "🛍️ 4. Etsy termékleírás, 13 SEO tag és címkészlet összeállítása az appban (20 perc)",
    ...
    "Szerda": {
        ...
        "target_minutes": 120,
        "tasks": [
            "🕊️ 1. 30 napos áhítat / napló vezérfonal és kulcsfontosságú KJV igék kiválasztása (20 perc)",
            "✍️ 2. Részletes áhítat szövegek, napi meditációk és imádságok megírása Gemini AI-val (40 perc)",
            "📑 3. Önreflexiós kérdések és naplózó feladatok kidolgozása a kiadványhoz (25 perc)",
            "🏷️ 4. Gumroad termékleírás, vásárlói előnyök és árképzés előkészítése (20 perc)",
    ...
    "Péntek": {
        ...
        "target_minutes": 120,
        "tasks": [
            "🎨 1. KDP Wrap-Around Borító méretezése és borítókép legenerálása a Gemini-ben (30 perc)",
            "📁 2. Heti Google Drive mappák (KDP, Etsy, Gumroad, Marketing) áttekintése és rendszerezése (25 perc)",
            ...
            "🏆 5. Heti fókuszblokkok értékelése és a 2-órás időnapló sikeres lezárása (20 perc)"
        ]
    }
}
